        ...
        with open(localunprocessedcsvpathname, 'r') as f:
            ...
            for row in reader:
                ...
                if len(mymarketvalue) > 0 and len(myprice) > 0:
                    ...
                    mydict[len(mydict)] = {'source':'barclays','category':'hyd','mysection1':mysection1,'mysection2':mysection2,'issue':issuename.strip(),'myprice':myprice,'mymarketvalue':mymarketvalue,'filename':filename}
