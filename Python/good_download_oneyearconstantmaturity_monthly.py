class procedure:
    ...
    def get_treasury_oneyear_constant_maturity_history(self):
        import datetime
        ...
        result = pdr.DataReader("GS1", "fred", yearago_date, today_date)
        return result
    
if __name__ == "__main__":
    o = procedure()
    df = o.get_treasury_oneyear_constant_maturity_history()
    print df
    import datetime
    today_date = datetime.date.today()
