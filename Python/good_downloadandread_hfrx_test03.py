...
localunprocessedfolder = 'C:\\Batches\\AutomationProjects\\Investment Strategy\\ETL\Downloads\\Unprocessed\\hfrx'
localprocessedfolder = 'C:\\Batches\\AutomationProjects\\Investment Strategy\\ETL\Downloads\\processed\\hfrx'
...
#outputfile = outputpath + '\\hfrx returns ' + filedatetime_string + '.txt'
...
try:
    ...
    soup = BeautifulSoup(remote_fo.read())
